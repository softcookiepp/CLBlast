...
Fork of CLBlast that has been heavily modified to use Vulkan.
================

It is not intended to be merged back into CLBlast itself.
Eventually it will be renamed, or factored into another library.
Some of the instructions listed below are incomplete or misleading.
Once enough refactoring is done to remove unused code for other APIs (OpenCL, CUDA,) the instructions will be updated.
