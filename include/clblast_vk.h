...
StatusCode Rotg(tart::buffer_ptr sa_buffer, const size_t sa_offset, tart::buffer_ptr sb_buffer, const size_t sb_offset, tart::buffer_ptr sc_buffer,
                ...
                const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Rotmg(tart::buffer_ptr sd1_buffer, const size_t sd1_offset, tart::buffer_ptr sd2_buffer, const size_t sd2_offset,
                 ...
                 tart::buffer_ptr sparam_buffer, const size_t sparam_offset, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Rotm(const size_t n, tart::buffer_ptr x_buffer, const size_t x_offset, const size_t x_inc, tart::buffer_ptr y_buffer,
                ...
                tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Dotu(const size_t n, tart::buffer_ptr dot_buffer, const size_t dot_offset, const tart::buffer_ptr x_buffer,
                ...
                const size_t y_inc, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Nrm2(const size_t n, tart::buffer_ptr nrm2_buffer, const size_t nrm2_offset, const tart::buffer_ptr x_buffer,
                const size_t x_offset, const size_t x_inc, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Sum(const size_t n, tart::buffer_ptr sum_buffer, const size_t sum_offset, const tart::buffer_ptr x_buffer, const size_t x_offset,
               const size_t x_inc, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Gemm(const Layout layout, const Transpose a_transpose, const Transpose b_transpose, const size_t m,
                ...
                const tart::event_ptr& event = nullptr, tart::buffer_ptr temp_buffer = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Symm(const Layout layout, const Side side, const Triangle triangle, const size_t m, const size_t n,
                ...
                const size_t c_ld, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Syr2k(const Layout layout, const Triangle triangle, const Transpose ab_transpose, const size_t n,
                 ...
                 const size_t c_offset, const size_t c_ld, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Had(const size_t n, const T alpha, const tart::buffer_ptr x_buffer, const size_t x_offset, const size_t x_inc,
               ...
               const size_t z_offset, const size_t z_inc, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Omatcopy(const Layout layout, const Transpose a_transpose, const size_t m, const size_t n, const T alpha,
                    ...
                    const size_t b_offset, const size_t b_ld, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode Convgemm(const KernelMode kernel_mode, const size_t channels, const size_t height, const size_t width,
                    ...
                    const size_t result_offset, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode AxpyBatched(const size_t n, const T* alphas, const tart::buffer_ptr x_buffer, const size_t* x_offsets,
                       ...
                       const size_t batch_count, tart::device_ptr queue, const tart::event_ptr& event = nullptr, const tart::command_sequence_ptr& sequence = nullptr);
...
StatusCode PUBLIC_API FillCache(const tart::device_ptr device);

// =================================================================================================

// Retrieves current tuning parameters for a specific device-precision-kernel combination
StatusCode PUBLIC_API RetrieveParameters(const tart::device_ptr device, const std::string& kernel_name,
...
StatusCode PUBLIC_API OverrideParameters(const tart::device_ptr device, const std::string& kernel_name,
                                         const Precision precision,
...
template <typename T>
StatusCode TuneXaxpy(tart::device_ptr queue, const size_t n, const double fraction,
                     std::unordered_map<std::string, size_t>& parameters);

// Tunes the "Xdot" kernel, used for level-1 reduction routines such as XDOT, XMAX, and XSUM
template <typename T>
StatusCode TuneXdot(tart::device_ptr queue, const size_t n, const double fraction,
                    std::unordered_map<std::string, size_t>& parameters);

// Tunes the "Xgemv" kernel, used for matrix-vector level-2 routines such as XGEMV, XGBMV, and XHEMV
template <typename T>
StatusCode TuneXgemv(tart::device_ptr queue, const size_t m, const size_t n, const double fraction,
                     std::unordered_map<std::string, size_t>& parameters);

// Tunes the "Xger" kernel, used for matrix update level-2 routines such as XGER, XHER, and XSYR2
template <typename T>
StatusCode TuneXger(tart::device_ptr queue, const size_t m, const size_t n, const double fraction,
                    std::unordered_map<std::string, size_t>& parameters);

// Tunes the "Xgemm" kernel, used for most level-3 routines such as XGEMM, XSYMM, and XHER2K
template <typename T>
StatusCode TuneXgemm(tart::device_ptr queue, const size_t m, const size_t n, const size_t k, const double fraction,
                     std::unordered_map<std::string, size_t>& parameters);

// Tunes the "XgemmDiret" kernel, used for most level-3 routines such as XGEMM, XSYMM, and XHER2K
template <typename T>
StatusCode TuneXgemmDirect(tart::device_ptr queue, const size_t m, const size_t n, const size_t k,
...
template <typename T>
StatusCode TuneCopy(tart::device_ptr queue, const size_t m, const size_t n, const double fraction,
                    std::unordered_map<std::string, size_t>& parameters);

// Tunes the "Pad" kernel, used for most level-3 routines such as XGEMM, XSYMM, and XHER2K
template <typename T>
StatusCode TunePad(tart::device_ptr queue, const size_t m, const size_t n, const double fraction,
                   std::unordered_map<std::string, size_t>& parameters);

// Tunes the "Transpose" kernel, used for most level-3 routines such as XGEMM, XSYMM, and XHER2K
template <typename T>
StatusCode TuneTranspose(tart::device_ptr queue, const size_t m, const size_t n, const double fraction,
                         std::unordered_map<std::string, size_t>& parameters);

// Tunes the "Padtranspose" kernel, used for most level-3 routines such as XGEMM, XSYMM, and XHER2K
template <typename T>
StatusCode TunePadtranspose(tart::device_ptr queue, const size_t m, const size_t n, const double fraction,
                            std::unordered_map<std::string, size_t>& parameters);

// Tunes the "Xgemm" kernel, used for the level-3 routine XTRSM
template <typename T>
StatusCode TuneInvert(tart::device_ptr queue, const size_t m, const size_t n, const size_t k, const double fraction,
                      std::unordered_map<std::string, size_t>& parameters);
