  ...
  "Xgemm", Precision::kHalf, {"GEMMK", "KREG", "KWG", "KWI", "MDIMA", "MDIMC", "MWG", "NDIMB", "NDIMC", "NWG", "SA", "SB", "STRM", "STRN", "VWM", "VWN"}, {
    ...
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        ...
        { "gfx1036", {
          { Name{"AMD Radeon Graphics                               "}, Params{ 0, 1, 32, 2, 8, 16, 128, 16, 16, 128, 1, 1, 1, 0, 8, 8 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 16, 128, 16, 16, 128, 1, 1, 1, 0, 8, 8 } },
        } },
        { "gfx1100", {
        ...
        { "gfx1201", {
          { Name{"AMD Radeon RX 9070 XT                             "}, Params{ 0, 1, 32, 2, 8, 8, 64, 8, 8, 64, 1, 1, 0, 0, 2, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 64, 8, 8, 64, 1, 1, 0, 0, 2, 4 } },
        } },
        { "gfx902", {
        ...
        { "gfx906:sramecc+:xnack-", {
          { Name{"AMD Instinct MI50/MI60                            "}, Params{ 0, 1, 32, 2, 8, 8, 32, 16, 16, 64, 1, 1, 0, 0, 2, 4 } },
    ...
    { // Intel GPUs
      kDeviceTypeGPU, "Intel", {
        { "default", {
          ...
          { Name{"Intel(R) UHD Graphics                             "}, Params{ 0, 1, 32, 2, 8, 8, 64, 8, 8, 64, 0, 0, 0, 0, 1, 1 } },
    ...
    { // QUALCOMM GPUs
      kDeviceTypeGPU, "QUALCOMM", {
        ...
        { "OpenCL C 3.0 Adreno(TM) 735", {
          { Name{"QUALCOMM Adreno(TM) 735                           "}, Params{ 0, 1, 32, 2, 16, 8, 64, 8, 16, 128, 0, 0, 1, 1, 4, 8 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 16, 8, 64, 8, 16, 128, 0, 0, 1, 1, 4, 8 } },
        } },
