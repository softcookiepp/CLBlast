...
const DatabaseEntry XgemmSingle = {
  "Xgemm", Precision::kSingle, {"GEMMK", "KREG", "KWG", "KWI", "MDIMA", "MDIMC", "MWG", "NDIMB", "NDIMC", "NWG", "SA", "SB", "STRM", "STRN", "VWM", "VWN"}, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        { "Ellesmere", {
          ...
          { Name{"AMD Radeon RX590 GME                              "}, Params{ 0, 1, 32, 2, 16, 16, 64, 32, 16, 128, 1, 1, 0, 1, 4, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 64, 16, 16, 64, 1, 1, 0, 0, 4, 4 } },
        } },
        { "Fiji", {
          { Name{"AMD Radeon 500 Series                             "}, Params{ 0, 1, 32, 2, 8, 16, 128, 16, 16, 128, 1, 1, 1, 0, 8, 8 } },
        ...
        { "gfx1035", {
          ...
          { Name{"AMD Radeon(TM) Graphics                           "}, Params{ 0, 1, 32, 2, 16, 8, 128, 8, 8, 64, 0, 1, 1, 0, 4, 1 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 32, 32, 64, 8, 8, 64, 0, 0, 0, 0, 1, 2 } },
        } },
        { "gfx1036", {
          { Name{"AMD Radeon Graphics                               "}, Params{ 0, 1, 32, 2, 8, 8, 128, 32, 16, 128, 1, 1, 1, 1, 4, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 128, 32, 16, 128, 1, 1, 1, 1, 4, 4 } },
        } },
        { "gfx1100", {
    ...
    { // ARM GPUs
      kDeviceTypeGPU, "ARM", {
        { "default", {
          { Name{"Mali-G615 MC5 r1p3                                "}, Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 0, 0, 0, 0, 4, 4 } },
    ...
    { // Apple GPUs
      kDeviceTypeGPU, "Apple", {
        { "default", {
          ...
          { Name{"Apple M2 Max                                      "}, Params{ 0, 1, 32, 2, 16, 16, 32, 8, 8, 32, 1, 1, 0, 0, 2, 2 } },
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        { "default", {
          ...
          { Name{"12th Gen Intel(R) Core(TM) i7-12700H              "}, Params{ 1, 4, 1, 1, 32, 32, 128, 4, 4, 128, 0, 0, 0, 0, 1, 1 } },
          ...
          { Name{"cpu-penryn-Intel(R) Core(TM)2 Duo CPU     T6670  @"}, Params{ 0, 1, 32, 2, 8, 8, 64, 8, 8, 64, 1, 1, 0, 0, 4, 2 } },
    ...
    { // Intel GPUs
      kDeviceTypeGPU, "Intel", {
        { "default", {
          ...
          { Name{"Intel(R) Graphics                                 "}, Params{ 0, 1, 32, 2, 32, 32, 128, 16, 8, 64, 0, 0, 0, 0, 1, 4 } },
          ...
          { Name{"Intel(R) Iris(R) Plus Graphics 640                "}, Params{ 1, 4, 1, 1, 16, 16, 64, 4, 4, 32, 0, 0, 0, 0, 4, 4 } },
          ...
          { Name{"Intel(R) UHD Graphics                             "}, Params{ 1, 4, 1, 1, 16, 16, 64, 8, 8, 64, 0, 0, 0, 0, 4, 4 } },
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        { "SM12.0", {
          { Name{"NVIDIA GeForce RTX 5060 Laptop GPU                "}, Params{ 0, 1, 32, 2, 8, 8, 64, 32, 16, 128, 1, 1, 1, 1, 2, 2 } },
          { Name{"NVIDIA GeForce RTX 5070 Ti                        "}, Params{ 0, 1, 32, 2, 8, 8, 32, 8, 16, 128, 1, 1, 0, 1, 4, 4 } },
        ...
        { "SM3.5", {
          ...
          { Name{"NVIDIA GeForce GT 730                             "}, Params{ 0, 1, 32, 2, 16, 16, 64, 16, 8, 64, 0, 1, 1, 0, 4, 2 } },
        ...
        { "SM5.0", {
          ...
          { Name{"Quadro M2000M                                     "}, Params{ 0, 1, 16, 2, 16, 16, 128, 32, 16, 128, 1, 1, 1, 1, 1, 2 } },
        ...
        { "SM6.1", {
          { Name{"GeForce GTX 1050 Ti                               "}, Params{ 0, 1, 16, 2, 32, 8, 128, 32, 16, 128, 1, 1, 1, 0, 4, 1 } },
          ...
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 1, 1, 0, 0, 4, 1 } },
        } },
        { "SM7.0", {
        ...
        { "SM7.5", {
          ...
          { Name{"NVIDIA GeForce GTX 1650 SUPER                     "}, Params{ 0, 1, 32, 2, 8, 8, 64, 32, 16, 128, 1, 1, 1, 1, 2, 2 } },
          { Name{"NVIDIA GeForce GTX 1650 Ti                        "}, Params{ 0, 1, 16, 2, 32, 8, 128, 32, 16, 128, 1, 1, 1, 0, 4, 1 } },
          { Name{"NVIDIA GeForce MX450                              "}, Params{ 0, 1, 32, 2, 8, 8, 64, 32, 16, 128, 1, 1, 1, 1, 2, 2 } },
          ...
          { kDeviceNameDefault                                        , Params{ 1, 4, 1, 1, 4, 4, 64, 8, 8, 32, 0, 0, 0, 0, 4, 4 } },
        } },
        { "SM8.0", {
        ...
        { "SM8.6", {
          ...
          { Name{"NVIDIA GeForce RTX 3050 Laptop GPU                "}, Params{ 0, 1, 32, 2, 8, 32, 128, 32, 8, 128, 0, 1, 1, 1, 4, 4 } },
          ...
          { Name{"NVIDIA GeForce RTX 3070 Laptop GPU                "}, Params{ 0, 1, 16, 2, 8, 8, 32, 8, 16, 128, 1, 0, 1, 1, 4, 8 } },
          ...
          { Name{"NVIDIA GeForce RTX 3080 Ti                        "}, Params{ 0, 1, 16, 2, 8, 8, 32, 32, 16, 128, 0, 1, 1, 1, 2, 2 } },
          { Name{"NVIDIA GeForce RTX 3090                           "}, Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 1, 1, 0, 0, 4, 4 } },
          { Name{"NVIDIA RTX A6000                                  "}, Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 1, 1, 0, 0, 4, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 16, 8, 8, 16, 0, 0, 0, 0, 2, 2 } },
        } },
        { "SM8.9", {
          { Name{"NVIDIA GeForce RTX 4050 Laptop GPU                "}, Params{ 0, 1, 32, 2, 8, 8, 64, 32, 16, 128, 1, 1, 1, 1, 2, 2 } },
          { Name{"NVIDIA GeForce RTX 4060                           "}, Params{ 0, 1, 32, 2, 8, 8, 32, 8, 8, 64, 1, 1, 0, 0, 4, 4 } },
          { Name{"NVIDIA GeForce RTX 4060 Laptop GPU                "}, Params{ 0, 1, 32, 2, 32, 32, 128, 8, 8, 64, 0, 1, 1, 1, 4, 4 } },
          ...
          { kDeviceNameDefault                                        , Params{ 1, 8, 1, 1, 8, 8, 64, 8, 8, 64, 0, 0, 0, 0, 4, 8 } },
        } },
        { "default", {
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 16, 8, 8, 32, 1, 1, 0, 0, 2, 4 } },
        } },
    ...
    { // QUALCOMM GPUs
      kDeviceTypeGPU, "QUALCOMM", {
        ...
        { "OpenCL C 3.0 Adreno(TM) 735", {
          { Name{"QUALCOMM Adreno(TM) 735                           "}, Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 0, 0, 0, 0, 4, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 0, 0, 0, 0, 4, 4 } },
        } },
        ...
        { "OpenCL C 3.0 Adreno(TM) 830", {
          { Name{"QUALCOMM Adreno(TM) 830                           "}, Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 0, 0, 0, 0, 4, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 0, 0, 0, 0, 4, 4 } },
        } },
      }
    },
    { // Default
      kDeviceTypeAll, "default", {
        { "default", {
          ...
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 16, 8, 8, 64, 0, 0, 0, 0, 1, 1 } },
        } },
      }
    },
  }
