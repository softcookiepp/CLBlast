  ...
  "Xgemm", Precision::kComplexSingle, {"GEMMK", "KREG", "KWG", "KWI", "MDIMA", "MDIMC", "MWG", "NDIMB", "NDIMC", "NWG", "SA", "SB", "STRM", "STRN", "VWM", "VWN"}, {
    ...
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        { "Ellesmere", {
          ...
          { Name{"AMD Radeon RX 580 2048SP                          "}, Params{ 0, 1, 16, 2, 16, 16, 32, 32, 16, 128, 1, 1, 1, 1, 1, 4 } },
          { Name{"AMD Radeon RX590 GME                              "}, Params{ 0, 1, 32, 2, 16, 16, 64, 16, 16, 64, 1, 1, 0, 0, 4, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 16, 16, 64, 16, 16, 64, 1, 1, 0, 0, 4, 4 } },
        } },
        { "Fiji", {
          { Name{"AMD Radeon 500 Series                             "}, Params{ 0, 1, 32, 2, 16, 16, 64, 16, 16, 64, 1, 1, 0, 0, 4, 4 } },
          ...
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 32, 32, 64, 8, 8, 64, 1, 1, 0, 0, 2, 1 } },
        } },
        { "Hawaii", {
          { Name{"AMD FirePro W8100                                 "}, Params{ 0, 1, 32, 2, 16, 16, 32, 16, 16, 32, 1, 1, 0, 0, 2, 1 } },
          { Name{"AMD Radeon R9 290X                                "}, Params{ 0, 1, 32, 2, 32, 8, 32, 8, 16, 32, 1, 0, 1, 0, 1, 1 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 16, 8, 32, 8, 16, 32, 1, 0, 0, 0, 1, 1 } },
        } },
        { "Oland", {
        ...
        { "gfx1010:xnack-", {
          { Name{"AMD Radeon RX 5700                                "}, Params{ 0, 1, 32, 2, 16, 8, 32, 16, 16, 64, 1, 1, 1, 0, 2, 2 } },
        ...
        { "gfx1035", {
          { Name{"AMD Radeon Graphics                               "}, Params{ 0, 1, 16, 2, 8, 16, 64, 32, 8, 64, 1, 1, 0, 0, 2, 1 } },
        ...
        { "gfx1101", {
          { Name{"AMD Radeon RX 7800 XT                             "}, Params{ 0, 1, 16, 2, 8, 8, 16, 32, 16, 64, 1, 0, 1, 1, 1, 1 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 16, 2, 8, 8, 16, 32, 16, 64, 1, 0, 1, 1, 1, 1 } },
        } },
        { "gfx1102", {
          { Name{"AMD Radeon RX 7600                                "}, Params{ 0, 1, 16, 2, 32, 32, 64, 16, 8, 128, 0, 0, 1, 1, 2, 2 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 16, 2, 32, 32, 64, 16, 8, 128, 0, 0, 1, 1, 2, 2 } },
        } },
        { "gfx1103", {
          { Name{"AMD Radeon 780M Graphics                          "}, Params{ 0, 1, 16, 2, 8, 8, 32, 8, 16, 128, 0, 0, 0, 1, 4, 2 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 16, 2, 8, 8, 32, 8, 16, 128, 0, 0, 0, 1, 4, 2 } },
        } },
        { "gfx1201", {
          { Name{"AMD Radeon RX 9070 XT                             "}, Params{ 0, 1, 32, 2, 16, 8, 32, 16, 16, 64, 1, 1, 1, 0, 2, 2 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 16, 8, 32, 16, 16, 64, 1, 1, 1, 0, 2, 2 } },
        } },
        { "gfx902", {
          { Name{"AMD Radeon(TM) Graphics                           "}, Params{ 0, 1, 16, 2, 16, 16, 32, 32, 16, 128, 1, 1, 1, 1, 1, 4 } },
          { Name{"AMD Radeon(TM) RX Vega 10 Graphics                "}, Params{ 0, 1, 32, 2, 16, 16, 64, 16, 16, 64, 1, 1, 0, 0, 4, 1 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 32, 32, 64, 8, 8, 64, 1, 1, 0, 0, 2, 4 } },
        } },
        { "gfx906:sramecc+:xnack-", {
          { Name{"AMD Instinct MI50/MI60                            "}, Params{ 0, 1, 32, 2, 32, 32, 32, 8, 8, 32, 1, 1, 0, 0, 1, 4 } },
          { Name{"AMD Radeon VII                                    "}, Params{ 0, 1, 32, 2, 16, 16, 32, 16, 16, 32, 1, 1, 0, 0, 1, 1 } },
    ...
    { // Apple GPUs
      kDeviceTypeGPU, "Apple", {
        { "default", {
          { Name{"Apple M1                                          "}, Params{ 0, 1, 32, 2, 32, 16, 64, 8, 8, 32, 0, 1, 1, 0, 2, 4 } },
          { Name{"Apple M2 Max                                      "}, Params{ 0, 1, 32, 2, 8, 8, 32, 8, 16, 32, 0, 1, 0, 1, 1, 2 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 32, 8, 16, 32, 0, 1, 0, 1, 1, 2 } },
        } },
      }
    },
    { // Imagination Technologies GPUs
      kDeviceTypeGPU, "Imagination Technologies", {
        { "default", {
          { Name{"PowerVR B-Series BXE-4-32                         "}, Params{ 0, 1, 32, 2, 8, 8, 32, 8, 8, 64, 0, 0, 0, 0, 4, 4 } },
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        { "default", {
          ...
          { Name{"12th Gen Intel(R) Core(TM) i7-12700H              "}, Params{ 1, 8, 1, 1, 16, 16, 16, 2, 2, 128, 0, 0, 0, 0, 1, 4 } },
          ...
          { Name{"cpu-penryn-Intel(R) Core(TM)2 Duo CPU     T6670  @"}, Params{ 0, 1, 32, 2, 8, 8, 32, 16, 16, 64, 1, 1, 0, 0, 4, 4 } },
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        ...
        { "SM3.5", {
          { Name{"GeForce 920A                                      "}, Params{ 0, 1, 32, 2, 8, 32, 128, 32, 8, 64, 0, 1, 0, 0, 4, 1 } },
          ...
          { Name{"NVIDIA GeForce GT 730                             "}, Params{ 0, 1, 16, 2, 16, 16, 64, 32, 8, 64, 0, 1, 1, 1, 4, 1 } },
        ...
        { "SM5.0", {
          ...
          { Name{"Quadro M2000M                                     "}, Params{ 0, 1, 16, 2, 16, 8, 128, 16, 32, 64, 1, 1, 1, 1, 1, 2 } },
        ...
        { "SM6.1", {
          { Name{"GeForce GTX 1050 Ti                               "}, Params{ 0, 1, 16, 2, 16, 8, 64, 8, 16, 64, 1, 1, 1, 1, 1, 4 } },
          ...
          { Name{"NVIDIA GeForce GTX 1060 6GB                       "}, Params{ 0, 1, 32, 2, 32, 32, 64, 32, 8, 64, 1, 1, 0, 1, 2, 1 } },
          { Name{"NVIDIA GeForce MX150                              "}, Params{ 0, 1, 16, 2, 32, 16, 64, 8, 8, 64, 1, 1, 1, 0, 1, 1 } },
          { Name{"TITAN X (Pascal)                                  "}, Params{ 0, 1, 32, 2, 32, 32, 64, 8, 8, 32, 1, 1, 0, 0, 2, 4 } },
          { Name{"Tesla P4                                          "}, Params{ 0, 1, 32, 2, 32, 32, 64, 16, 16, 64, 1, 1, 0, 0, 1, 2 } },
        ...
        { "SM7.5", {
          { Name{"GeForce GTX 1650                                  "}, Params{ 0, 1, 16, 2, 8, 8, 16, 16, 16, 64, 1, 0, 1, 1, 2, 2 } },
          { Name{"NVIDIA GeForce GTX 1650 SUPER                     "}, Params{ 0, 1, 16, 2, 32, 8, 32, 16, 32, 128, 1, 0, 0, 0, 1, 4 } },
          { Name{"NVIDIA GeForce GTX 1650 Ti                        "}, Params{ 0, 1, 32, 2, 8, 8, 32, 8, 8, 64, 0, 0, 0, 0, 2, 4 } },
          { Name{"NVIDIA GeForce MX450                              "}, Params{ 0, 1, 16, 2, 16, 8, 64, 8, 16, 64, 1, 1, 1, 1, 1, 4 } },
          { Name{"NVIDIA GeForce RTX 2060                           "}, Params{ 0, 1, 16, 2, 8, 8, 32, 32, 16, 128, 0, 1, 1, 1, 2, 2 } },
          { Name{"NVIDIA GeForce RTX 2070 SUPER                     "}, Params{ 0, 1, 32, 2, 8, 16, 64, 32, 8, 32, 0, 0, 1, 0, 1, 1 } },
          { Name{"NVIDIA GeForce RTX 2070 Super                     "}, Params{ 1, 16, 1, 1, 16, 16, 64, 4, 4, 32, 0, 0, 0, 0, 1, 8 } },
          { Name{"NVIDIA GeForce RTX 2070 with Max-Q Design         "}, Params{ 1, 4, 1, 1, 32, 32, 128, 8, 8, 64, 0, 0, 0, 0, 1, 2 } },
          { Name{"NVIDIA GeForce RTX 2080 Ti                        "}, Params{ 1, 4, 1, 1, 8, 8, 32, 16, 16, 128, 0, 0, 0, 0, 4, 2 } },
          { Name{"NVIDIA GeForce RTX 2080 with Max-Q Design         "}, Params{ 0, 1, 16, 2, 8, 8, 128, 16, 16, 64, 1, 0, 1, 0, 1, 1 } },
        ...
        { "SM8.6", {
          ...
          { Name{"NVIDIA GeForce RTX 3080 Ti                        "}, Params{ 0, 1, 32, 2, 32, 8, 128, 16, 16, 64, 1, 0, 1, 0, 2, 1 } },
          { Name{"NVIDIA GeForce RTX 3090                           "}, Params{ 1, 4, 1, 1, 8, 8, 32, 16, 16, 128, 0, 0, 0, 0, 4, 2 } },
          { Name{"NVIDIA RTX A6000                                  "}, Params{ 1, 4, 1, 1, 4, 4, 32, 8, 8, 64, 0, 0, 0, 0, 1, 1 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 16, 8, 8, 16, 0, 0, 0, 0, 1, 2 } },
        } },
        { "SM8.9", {
          { Name{"NVIDIA GeForce RTX 4050 Laptop GPU                "}, Params{ 0, 1, 16, 2, 16, 8, 64, 8, 16, 64, 1, 1, 1, 1, 1, 4 } },
          { Name{"NVIDIA GeForce RTX 4060                           "}, Params{ 0, 1, 16, 2, 8, 8, 32, 32, 16, 128, 0, 1, 1, 1, 2, 2 } },
          { Name{"NVIDIA GeForce RTX 4060 Laptop GPU                "}, Params{ 0, 1, 16, 2, 16, 8, 64, 8, 16, 64, 1, 1, 1, 1, 1, 4 } },
          { Name{"NVIDIA GeForce RTX 4060 Ti                        "}, Params{ 0, 1, 16, 2, 8, 8, 128, 16, 16, 64, 1, 0, 1, 0, 1, 1 } },
          { Name{"NVIDIA GeForce RTX 4070 Laptop GPU                "}, Params{ 1, 16, 1, 1, 16, 16, 64, 4, 4, 32, 0, 0, 0, 0, 1, 8 } },
          { Name{"NVIDIA GeForce RTX 4070 Ti                        "}, Params{ 0, 1, 16, 2, 16, 8, 64, 8, 16, 64, 1, 1, 1, 1, 1, 4 } },
          { Name{"NVIDIA GeForce RTX 4080                           "}, Params{ 1, 16, 1, 1, 16, 16, 64, 4, 4, 32, 0, 0, 0, 0, 1, 8 } },
          { Name{"NVIDIA GeForce RTX 4090                           "}, Params{ 0, 1, 16, 2, 16, 8, 64, 8, 16, 64, 1, 1, 1, 1, 1, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 16, 8, 8, 16, 0, 0, 0, 0, 1, 2 } },
        } },
        { "default", {
