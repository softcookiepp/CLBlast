  ...
  "Xgemm", Precision::kDouble, {"GEMMK", "KREG", "KWG", "KWI", "MDIMA", "MDIMC", "MWG", "NDIMB", "NDIMC", "NWG", "SA", "SB", "STRM", "STRN", "VWM", "VWN"}, {
    ...
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        ...
        { "gfx1035", {
          ...
          { Name{"AMD Radeon(TM) Graphics                           "}, Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 1, 1, 0, 0, 2, 4 } },
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 1, 1, 0, 0, 4, 4 } },
        } },
        { "gfx1036", {
          { Name{"AMD Radeon Graphics                               "}, Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 1, 1, 0, 0, 4, 2 } },
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        { "default", {
          ...
          { Name{"12th Gen Intel(R) Core(TM) i7-12700H              "}, Params{ 0, 1, 32, 2, 16, 16, 16, 8, 8, 16, 1, 1, 0, 0, 1, 2 } },
          ...
          { Name{"cpu-penryn-Intel(R) Core(TM)2 Duo CPU     T6670  @"}, Params{ 0, 1, 32, 2, 16, 16, 64, 16, 16, 64, 1, 1, 0, 0, 4, 1 } },
    ...
    { // Intel GPUs
      kDeviceTypeGPU, "Intel", {
        { "default", {
          ...
          { Name{"Intel(R) Iris(R) Plus Graphics 640                "}, Params{ 0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 0, 0, 0, 0, 1, 1 } },
          { Name{"Intel(R) UHD Graphics                             "}, Params{ 1, 2, 1, 1, 8, 8, 32, 8, 8, 64, 0, 0, 0, 0, 2, 2 } },
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        { "SM12.0", {
          { Name{"NVIDIA GeForce RTX 5060 Laptop GPU                "}, Params{ 0, 1, 32, 2, 8, 8, 16, 16, 16, 32, 1, 1, 0, 0, 2, 2 } },
          { Name{"NVIDIA GeForce RTX 5070 Ti                        "}, Params{ 0, 1, 32, 2, 16, 16, 16, 8, 8, 16, 1, 1, 0, 0, 1, 2 } },
        ...
        { "SM6.1", {
          { Name{"GeForce GTX 1050 Ti                               "}, Params{ 1, 4, 1, 1, 4, 4, 8, 16, 16, 64, 0, 0, 0, 0, 2, 2 } },
        ...
        { "SM7.5", {
          ...
          { Name{"NVIDIA GeForce MX450                              "}, Params{ 0, 1, 32, 2, 8, 8, 16, 8, 8, 16, 0, 0, 0, 0, 2, 2 } },
        ...
        { "SM8.6", {
          ...
          { Name{"NVIDIA GeForce RTX 3050 Laptop GPU                "}, Params{ 1, 8, 1, 1, 8, 8, 32, 8, 8, 64, 0, 0, 0, 0, 4, 2 } },
          { Name{"NVIDIA GeForce RTX 3050 Ti Laptop GPU             "}, Params{ 0, 1, 32, 2, 8, 8, 16, 16, 16, 16, 1, 1, 0, 0, 1, 1 } },
          ...
          { Name{"NVIDIA GeForce RTX 3070 Laptop GPU                "}, Params{ 0, 1, 32, 2, 8, 8, 32, 32, 32, 32, 1, 1, 1, 0, 4, 1 } },
          ...
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 16, 8, 8, 16, 1, 1, 0, 0, 1, 2 } },
        } },
        { "SM8.9", {
          { Name{"NVIDIA GeForce RTX 4050 Laptop GPU                "}, Params{ 1, 8, 1, 1, 8, 8, 16, 32, 32, 64, 0, 0, 0, 0, 1, 1 } },
          { Name{"NVIDIA GeForce RTX 4060                           "}, Params{ 1, 8, 1, 1, 8, 8, 16, 32, 32, 64, 0, 0, 0, 0, 1, 1 } },
          { Name{"NVIDIA GeForce RTX 4060 Laptop GPU                "}, Params{ 1, 4, 1, 1, 4, 4, 16, 16, 16, 32, 0, 0, 0, 0, 1, 1 } },
    ...
    { // Default
      kDeviceTypeAll, "default", {
        { "default", {
          ...
          { kDeviceNameDefault                                        , Params{ 0, 1, 32, 2, 8, 8, 16, 8, 8, 32, 1, 1, 0, 0, 1, 1 } },
        } },
      }
    },
  }
