...
template <typename T>
Xspmv<T>::Xspmv(Queue& queue, EventPointer event, const std::string& name) : Xgemv<T>(queue, event, name) {}

// =================================================================================================

// The main routine
template <typename T>
void Xspmv<T>::DoSpmv(const Layout layout, const Triangle triangle, const size_t n, const T alpha,
