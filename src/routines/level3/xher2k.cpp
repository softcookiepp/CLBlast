...
Xher2k<T, U>::Xher2k(Queue& queue, EventPointer event, const std::string& name) : Xherk<T, U>(queue, event, name) {}

// =================================================================================================

// The main routine
template <typename T, typename U>
void Xher2k<T, U>::DoHer2k(const Layout layout, const Triangle triangle, const Transpose ab_transpose, const size_t n,
	...
	const U beta, const Buffer<T>& c_buffer, const size_t c_offset, const size_t c_ld, const tart::command_sequence_ptr& sequence)
{
	...
	HerkAB(layout, triangle, ab_transpose, negated_ab_transpose, n, k, alpha, a_buffer, a_offset, a_ld, b_buffer,
				 b_offset, b_ld, complex_beta, c_buffer, c_offset, c_ld, first_herk_event.pointer(), false, workingSequence);
	...
	HerkAB(layout, triangle, ab_transpose, negated_ab_transpose, n, k, conjugate_alpha, b_buffer, b_offset, b_ld,
				 a_buffer, a_offset, a_ld, complex_one, c_buffer, c_offset, c_ld, event_, true, workingSequence);
